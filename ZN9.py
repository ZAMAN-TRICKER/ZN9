...
a=requests.get("https://github.com/ZAMAN-TRICKER/ZN8/blob/main/ZN8.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    kok = ("Hi Zaman Sir, I Need To Buy Your Zaman-PAID Tools Version 1.3 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+key1)
